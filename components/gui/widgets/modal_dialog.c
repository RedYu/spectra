...
#define MODAL_DIALOG_BACKGROUND_COLOR   0x20252A
#define MODAL_DIALOG_BORDER_COLOR       0x414A52

#define MODAL_TITLE_COLOR               0xFFFFFF
#define MODAL_TEXT_COLOR                0xCDD3D8
#define MODAL_PROGRESS_TEXT_COLOR       0xAEB7BF

#define MODAL_PRIMARY_COLOR             0x4B77D1
#define MODAL_PRIMARY_PRESSED_COLOR     0x3F66B8

#define MODAL_SECONDARY_COLOR           0x343B42
#define MODAL_SECONDARY_PRESSED_COLOR   0x414A52

#define MODAL_DISABLED_COLOR            0x596168
#define MODAL_PROGRESS_BACKGROUND       0x343B42
